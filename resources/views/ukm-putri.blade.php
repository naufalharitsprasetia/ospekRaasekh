...
@section('content')
    ...
    <div class="ukm background-terang px-4 py-3">
        <div class="breadcrumb"><a href="/lainnya"
                class="text-decoration-none hover-breadcrumb tulisan-gelap fw-bold pe-2">Others </a> / UKM (putri)
        </div>
        <div class="title text-center">
            <h1 class="tulisan-gelap text-center fw-bolder">Unit Kegiatan Mahasiswa (UKM) - Unida Mantingan (Putri)</h1>
        </div>
        <hr>
        <div class="container mx-2 my-2 ">
            <div class="row d-flex justify-content-around">
                ...
                <div class="card card-ukm background-gelap mb-3 col-3 mx-1 my-2 pb-3 px-0">
                    ...
                    <div class="tombol-detail-ukm mx-3">
                ...
                {{-- Card UKM --}}
                <div class="card card-ukm background-gelap mb-3 col-3 mx-1 my-2 pb-3 px-0">
                    <img src="assets/ukm-putri/UKM-HADRAH.jpg" class="card-img-top">
                    <div class="ukm-title d-flex my-3 align-items-center justify-content-center">
                        <h5 class="card-title tulisan-terang mx-4">UKM HADRAH</h5>
                    </div>
                    <div class="tombol-detail-ukm mx-3">
                        <a href="" class="btn detail-btn-ukm background-terang w-100">Lihat Detail</a>
                    </div>
                ...
                {{-- Card UKM --}}
                <div class="card card-ukm background-gelap mb-3 col-3 mx-1 my-2 pb-3 px-0">
                    <img src="assets/ukm-putri/UKM-TARI.jpg" class="card-img-top">
                    <div class="ukm-title d-flex my-3 align-items-center justify-content-center">
                        <h5 class="card-title tulisan-terang mx-4">UKM TARI</h5>
                    </div>
                    <div class="tombol-detail-ukm mx-3">
                        <a href="" class="btn detail-btn-ukm background-terang w-100">Lihat Detail</a>
                    </div>
